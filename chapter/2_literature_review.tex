...
From an empirical perspective, these domains should be treated as related but non-equivalent margins of transformation. AI/ML and advanced analytics are typically data- and talent-intensive, with higher setup costs and longer learning cycles. Cloud adoption often lowers entry costs and speeds deployment, while IoT programs require joint redesign of software and physical production processes. Blockchain applications are frequently narrower in scope, but can be valuable in traceability-intensive supply chains. As a result, measured digital intensity can evolve at different speeds across domains even under the same financing environment~\cite{Wang2024,Ren2024}.
...
At the same time, external financing does not mechanically translate into successful digital upgrading. The pass-through from capital access to implementation depends on absorptive capacity, including managerial quality, organizational readiness, and local complementary infrastructure. This interaction helps explain why treatment effects can differ sharply across firms and regions in emerging economies.
...
The financing-constraint mechanism is the most direct link between liberalization and digital transformation. Digital projects often require large upfront expenses in software systems, data architecture, cloud migration, machine learning platforms, and organizational training~\cite{Kose2003}. By broadening access to equity investors and lowering required returns, liberalization can reduce the user cost of capital for these projects~\cite{LiPang2023}.
