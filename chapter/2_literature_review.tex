...
Emerging markets offer a unique digital transformation landscape with both growth opportunities and structural challenges~\cite{Zhao2023}. In this setting, access to external capital markets can serve a catalytic function. International investors may not only supply funding but also bring governance oversight, benchmarking standards, and a focus on long-term capability building~\cite{Li2025}. In China, the coexistence of advanced digital ecosystems and uneven regional development creates an especially revealing context for identifying heterogeneous treatment effects~\cite{Du2024}.
