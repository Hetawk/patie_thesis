...
This thesis examines whether capital market liberalization promotes firm-level digital transformation, using the phased inclusion of Chinese A-shares in the MSCI Emerging Markets Index as a quasi-experimental setting. The central analytical position is that digital transformation is an investment process shaped by both internal managerial capability and external capital-market institutions. From this perspective, the question shifts from \emph{whether} firms transform to \emph{how} financial opening changes the conditions that make transformation feasible, credible, and persistent.
...
Building on these motivations, the thesis addresses three research questions.
...
Chapter~3 provides the institutional background, including China's pre-liberalization capital market structure and the MSCI inclusion process, and develops the formal hypotheses.
