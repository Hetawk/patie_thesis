...
This study examines whether capital market liberalization is associated with changes in firm-level digital transformation by exploiting the phased inclusion of Chinese A-shares in the MSCI Emerging Markets Index as quasi-exogenous policy variation. It models digital transformation as a long-horizon intangible investment process shaped by managerial capability and external financing and governance conditions. The empirical analysis therefore provides identification-oriented evidence on whether financial opening relaxes these constraints and increases transformation intensity, rather than only describing whether firms transform.
...
\begin{itemize}
    \item First, does inclusion in the MSCI Emerging Markets Index, a proxy for capital market liberalization, significantly increase firm-level digital transformation intensity? This is the study's primary identification question. Specifically, the analysis evaluates whether treated firms exhibit a sustained post-inclusion increase in digital transformation relative to otherwise comparable untreated firms.
...
Overall, the design is intentionally triangulated: one institutional shock, multiple estimators, multiple outcome definitions, and multiple mechanism checks. This triangulation increases confidence that the results are not artifacts of any single model choice, while still requiring cautious interpretation under estimator sensitivity and measurement limits.
...
\begin{itemize}
    ...
    \item Fourth, the study enhances methodology by combining quasi-experimental inference with validated Chinese-language text analytics at scale.
