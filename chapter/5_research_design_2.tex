...
Dictionary quality is validated through manual coding of 500 randomly selected annual-report excerpts by two independent raters with expertise in Chinese corporate finance. Inter-rater reliability reaches Cohen's $\kappa = 0.89$, above the conventional $\kappa \geq 0.80$ benchmark for high agreement. Coding disagreements are resolved through expert adjudication, and ambiguous terms are removed or refined before final implementation.
