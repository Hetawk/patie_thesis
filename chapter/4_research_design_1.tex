...
Each design component is paired with the inferential risk it addresses---selection on observables, differential pre-trends, timing heterogeneity, and disclosure-measurement artifacts---so that readers can assess not only the final estimator, but also the assumptions behind it.
